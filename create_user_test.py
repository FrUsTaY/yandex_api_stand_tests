...
def get_user_body(first_name):
    # копирование словаря с телом запроса из файла data, чтобы
# не потерять данные в исходном словаре
...
def negative_assert_symbol(first_name):
    ...
    assert response.json()["code"] != "Имя пользователя\
     введено некорректно. Имя может содержать только русские \
     или латинские буквы, длина должна быть не менее 2 и не \
     более 15 символов"
...
#C:\Users\user\PycharmProjects\yandex_api_stand_tests1